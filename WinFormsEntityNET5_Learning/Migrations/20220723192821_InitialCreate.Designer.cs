...
namespace WinFormsEntityNET5_Learning.Migrations
{
    ...
    [Migration("20220723192821_InitialCreate")]
            ...
            modelBuilder.Entity("WinFormsEntityNET5_Learning.Models.Study", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            PatientId = 1,
                            StudyDate = new DateTime(2022, 7, 23, 22, 28, 21, 167, DateTimeKind.Local).AddTicks(5703)
                        },
                        new
                        {
                            Id = 2,
                            PatientId = 1,
                            StudyDate = new DateTime(2022, 5, 28, 22, 28, 21, 168, DateTimeKind.Local).AddTicks(2164)
                        },
                        new
                        {
                            Id = 3,
                            PatientId = 2,
                            StudyDate = new DateTime(2022, 7, 20, 22, 28, 21, 168, DateTimeKind.Local).AddTicks(2222)
                        },
                        new
                        {
                            Id = 4,
                            PatientId = 3,
                            StudyDate = new DateTime(2022, 7, 23, 22, 28, 21, 168, DateTimeKind.Local).AddTicks(2226)
                        },
                        new
                        {
                            Id = 5,
                            PatientId = 4,
                            StudyDate = new DateTime(2022, 7, 11, 22, 28, 21, 168, DateTimeKind.Local).AddTicks(2227)
                        },
                        new
                        {
                            Id = 6,
                            PatientId = 4,
                            StudyDate = new DateTime(2022, 6, 26, 22, 28, 21, 168, DateTimeKind.Local).AddTicks(2228)
                        });
                });
